...
@HiltViewModel
class FavoritesViewModel @Inject constructor(private val fetchLyricsFromLocalUseCase: FetchLyricsFromLocalUseCase)
    : ViewModel() {
    ...
    init {
        fetchLyricsFromLocal()
    }

    private fun fetchLyricsFromLocal(){
